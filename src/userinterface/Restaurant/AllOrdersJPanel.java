...
public class AllOrdersJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form AllOrdersJPanel
     */
    ...
    UserAccount account;
    public AllOrdersJPanel(JPanel userProcessContainer,EcoSystem ecosystem, UserAccount account) {
        initComponents();
        initListners();
    ...
    private void initComponents() {
        ...
        tblRestaurantWorkRequest.setFont(new java.awt.Font("Optima", 0, 12)); // NOI18N
        tblRestaurantWorkRequest.setForeground(new java.awt.Color(87, 132, 186));
                ...
                if (selectedRow >= 0) {
                    ...
                    if (request instanceof OrderWorkRequest) {
                        ...
                        if (orderWorkRequest != null) {
                           AcceptOrderJPanel manageOrderDetailsJPanel = new AcceptOrderJPanel(userProcessContainer,ecosystem,account,orderWorkRequest);
